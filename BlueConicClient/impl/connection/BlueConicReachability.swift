...
func callback(reachability:SCNetworkReachability, flags: SCNetworkReachabilityFlags, info: UnsafeMutablePointer<Void>) {
    let reachability = Unmanaged<BlueConicReachability>.fromOpaque(COpaquePointer(info)).takeUnretainedValue()
...
public class BlueConicReachability: NSObject {

    public typealias NetworkReachable = (BlueConicReachability) -> ()
    public typealias NetworkUnreachable = (BlueConicReachability) -> ()
    ...
    public class func reachabilityForInternetConnection() -> BlueConicReachability? {
        ...
        return BlueConicReachability(reachabilityRef: ref)
    }

    public class func reachabilityForLocalWiFi() -> BlueConicReachability? {
